        ...
        <div class="grid wide">
          <nav class="navbar1">
            <ul class="navbar__list">
              <li class="navbar__list-item separate">
                <a href="./introduce.php" class="gt_hui"
                  >Giới thiệu về OHUI</a
                >
              </li>
              ...
              <li class="navbar__list-item">
                ...
                <a
                  href="https://www.facebook.com/bam.nguien"
          ...
          <div class="header__logo" style="margin-top: 10px;">
            ...
            <div class="header__logo_text">Thanh Toán</div>
          </div>
        </div>
      </header>
    </div>